...
/**
 * Created by nataliebrammerjensen on 02/12/2017.
 */

public class DatabaseHelperConversation extends SQLiteOpenHelper {
    private static final String TAG = "DatabaseHelper";

    //ConversationEvent
    private static final String TABLE_NAME = "conversation_tableTwo"; //profiles
    ...
    public DatabaseHelperConversation(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTable = "CREATE TABLE " + TABLE_NAME + " (ID TEXT, " + COL2 + " TEXT, " + COL3 + " TEXT, " + COL4 + " TEXT " + ");";
    ...
    public boolean addData(String itemCOL1, String itemCOL2, String itemCOL3, String itemCOL4) {
        ...
        Log.d(TAG, "addData: Adding " + itemCOL1 + itemCOL2 + "and " + itemCOL3 + "and " + itemCOL3 +  " to " + TABLE_NAME);
